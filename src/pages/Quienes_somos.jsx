  ...
  return (
    <>
      ...
      <p>
        ...
        necesitadas ofertando los productos que realmente creemos que le pueden
        ir bien a su empresa para así poder ayudar. En estos momentos nos
        encontramos trabajando con la Fundación Oncológica Ícaro Infantil,<b><i> el
        día 15 de febrero se realiza el día internacional del cáncer infantil</i></b> y
        ...
        necesitan. </p>
        <div className="logo">
      <img src={logo} alt="Logo de la campaña" />
      </div>
